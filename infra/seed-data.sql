-- Seed database with sample users, channels, and videos
-- Password hash for 'password123' using bcrypt
-- $2a$12$LQv3c1yqBo9SkvXS7QTJp.6ySl0VLX3FoXccnUiV1JqWpFHc3WUOW
...
-- ============================================
-- VIDEOS (status=READY, isPublic=true, isDeleted=false, publishedAt set)
-- ============================================
...
VALUES
  ...
  ('v1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000001',
   ...
   'Learn how to build a scalable video streaming platform with Node.js, React, and FFmpeg. Complete guide from setup to deployment.',
  ...
  ('v1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000001',
   ...
   'Master TypeScript from basics to advanced concepts. Build type-safe applications with confidence.',
  ...
  ('v1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000001',
   ...
   'Deploy your applications with Docker and Kubernetes. Learn containerization and orchestration best practices.',
  ...
  ('v1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000001',
   ...
   'Quick overview of useState and useEffect hooks for React developers',
  ...
  -- Gaming Central videos
  ('v2000000-0000-0000-0000-000000000005', 'c2000000-0000-0000-0000-000000000002',
   'Top 10 Games of 2026 - Must Play!',
   'Our picks for the best games released this year. From indie gems to AAA blockbusters.',
  ...
  ('v2000000-0000-0000-0000-000000000006', 'c2000000-0000-0000-0000-000000000002',
   ...
   'Complete walkthrough of the latest Elden Ring DLC. All bosses, secrets, and endings covered.',
  ...
  ('v3000000-0000-0000-0000-000000000008', 'c3000000-0000-0000-0000-000000000003',
   ...
   'Exploring the best street food in Tokyo! From ramen to takoyaki, join me on this delicious adventure.',
  ...
  ('v3000000-0000-0000-0000-000000000009', 'c3000000-0000-0000-0000-000000000003',
   ...
   'Follow me through a typical day - from morning routine to editing videos late at night.',
  ...
  ('v4000000-0000-0000-0000-000000000010', 'c4000000-0000-0000-0000-000000000004',
   ...
   'Relaxing lofi beats perfect for studying, working, or just chilling. 2 hours of continuous music.',
  ...
  ('v4000000-0000-0000-0000-000000000011', 'c4000000-0000-0000-0000-000000000004',
   ...
   'Beginner-friendly music production tutorial. Learn the basics of FL Studio and create your first beat.',
  ...
  ('v4000000-0000-0000-0000-000000000012', 'c4000000-0000-0000-0000-000000000004',
   ...
   'Can you play this riff? Drop a comment with your attempt!',
  ...
  ('v5000000-0000-0000-0000-000000000013', 'c5000000-0000-0000-0000-000000000005',
   ...
   'Learn the fundamentals of machine learning in under 2 hours. From linear regression to neural networks.',
  ...
  ('v5000000-0000-0000-0000-000000000014', 'c5000000-0000-0000-0000-000000000005',
   ...
   'Everything you need to know for system design interviews. Real examples from FAANG companies.',
  ...
  ('v5000000-0000-0000-0000-000000000015', 'c5000000-0000-0000-0000-000000000005',
   ...
   'The definitive guide to choosing between CSS Grid and Flexbox for your layouts.',
  ...
  ('v1000000-0000-0000-0000-000000000017', 'c1000000-0000-0000-0000-000000000001',
   'Next.js 15 - What''s New and Migration Guide',
   'Explore the exciting new features in Next.js 15 and learn how to migrate your existing projects.',
  ...
  ('v2000000-0000-0000-0000-000000000018', 'c2000000-0000-0000-0000-000000000002',
   ...
   'Build the ultimate gaming PC without breaking the bank. Full parts list and assembly guide.',
  ...
  ('v3000000-0000-0000-0000-000000000019', 'c3000000-0000-0000-0000-000000000003',
   ...
   'Discover the secret spots in Bali that most tourists miss. Local tips and budget-friendly advice.',
  ...
  ('v5000000-0000-0000-0000-000000000020', 'c5000000-0000-0000-0000-000000000005',
   ...
   'An honest comparison of Rust and Go for backend development. Performance benchmarks included.',
...
-- ============================================
-- SUBSCRIPTIONS (sample cross-subscriptions)
-- ============================================
